                    ...
                    ?>
                            <form method="POST">
                                <div class="row m-2">
                                    ...
                                    <div class="col-sm-2">
                                        <h6 class="card-text align-middle"><?php echo $row["ime"] . " " . $row["prezime"] ?></h6>
                                    </div>
                                    <div class="col-sm-2 ">
                                        <h6 class="card-text align-middle"><?php echo $row["status_naziv"] ?></h6>
                                    </div>
                                    <div class="col-sm-2 ">
                                        <h6 class="card-text align-middle"><?php foreach ($predmeti as $predmet) {
                                                                                echo $predmet . " ";
                                                                            } ?></h6>
                                    </div>

                                    <div class="col-sm-2">
                                        <a class="btn btn-primary align-middle" href="../<?php echo $row["autentikacija"] ?>" download>Preuzmi autentikaciju</a>
                                    </div>
