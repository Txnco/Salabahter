<div class="col-sm-3">
    <div class="card p-3">
        ...
        <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="svikorisnici.php" class="nav-link nadlink <?php echo $trenutnaStranica2 == "korisnici" ? 'aktivno' : '' ?>">Svi korisnici</a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link nadlink <?php echo $trenutnaStranica2 == "skripte" ? 'aktivno' : '' ?>">Sve skripte</a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link nadlink <?php echo $trenutnaStranica2 == "grupekartica" ? 'aktivno' : '' ?>">Sve grupe kartica</a>
            </li>
        </ul>
    </div>
</div>